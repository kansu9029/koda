...
function goFilter(){
  ...
  var wSelect1 = document.getElementById("weaponSelect");
  var wSelect2 = document.getElementById("zokuseiSelect");
  var value1  = wSelect1.options[wSelect1.selectedIndex ].value;
  var value2  = wSelect2.options[wSelect2.selectedIndex ].value;
  if(value1 == 'all'){
    // --- 全ての場合はクラスをクリア ---
    if(value2 == "all"){
      wTable.className = "type06";
    }else{
      wTable.className = 'allNoDisplay ' + value2;
    }
  }else{
    if(value2 == 'all'){
      wTable.className = 'allNoDisplay ' + value1;
    }else{
      //value2 = value2+'r'
      //value2
      var value3 = value2 + 'r';
      wTable.className = 'allNoDisplay ' + value1 +' '+ value3;
    }
